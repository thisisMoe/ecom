            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        <h2 class="lead fw-normal text-muted mb-4 px-lg-10">Now you can buy anything from AliExpress in just 30 Seconds</h2>
                        <!-- Button Modal -->
                        <div class="d-flex justify-content-center align-items-center mb-5">
                            <form action="{{ route('searchProduct') }}" class="w-100" method="GET">
                                <div class="input-group">
                                    <input type="text" name="q" class="form-control" id="searchProduct" placeholder="Coller un lien AliExpress ici..." aria-label="Search"
            ...
            <div class="container">
                <div class="row justify-content-center mb-5 mb-lg-6">
                    <div class="col-6 col-md-3 text-center mb-4">
                        ...
                        <p class="text-gray">Clients Satisfaits</p>
                    </div>
                    <div class="col-6 col-md-3 text-center mb-4">
                        <div class="icon icon-shape icon-lg bg-white shadow-lg border-light rounded-circle mb-4">
                        ...
                        <p class="text-gray">Commandes Livrées</p>
                    </div>
                </div>
            </div>
        </section>
